...
public class SeverinScript : EnemyScript
{
    ...
    */
    ...
    public override void Update()
    {
        ...
        {
            //Not moving away to prepare for the massive attack
            if (!enemyChar.animator.GetBool("dashAway")) 
            {
            ...
            else //moving away to do the massive attack
            {
                //
                //
                //
                ...
                //
                //
                //Look at steps at the top for plans for this
